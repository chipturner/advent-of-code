...
def main() -> None:
    ...
    big_g[3 * start[0] + 2, 3 * start[1] + 1] = big_g[3 * start[0] + 3, 3 * start[1] + 1]
    big_g[3 * start[0] + 0, 3 * start[1] + 1] = big_g[3 * start[0] - 1, 3 * start[1] + 1]

    big_g[3 * start[0] + 1, 3 * start[1] + 2] = big_g[3 * start[0] + 1, 3 * start[1] + 3]
    big_g[3 * start[0] + 1, 3 * start[1] + 0] = big_g[3 * start[0] + 1, 3 * start[1] - 1]
